...
def full_cartons_of_eggs():
    ...
    eggs_number = int(eggs) #converts to integer
    cartons = eggs_number // 12 #divides by 12 and finds remainder after whole number divisions respectively
    remainder = eggs_number % 12 #using helpful tips from homework for the remainder
    print(f"There are {cartons} cartons of eggs with {remainder} remaining.") #f function to print with variables
